    ...
    public partial class Sec : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleAccessRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleAccessRules_AccessRules_AccessRuleId",
                        column: x => x.AccessRuleId,
                        principalTable: "AccessRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleAccessRules_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_UserCreatorId",
                table: "Messages",
                column: "UserCreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleAccessRules_AccessRuleId",
                table: "RoleAccessRules",
                column: "AccessRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleAccessRules_RoleId",
                table: "RoleAccessRules",
                column: "RoleId");
